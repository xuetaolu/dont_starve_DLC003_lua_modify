...
function CraftSlots:Highlight(category)
	self.highlightCategory = category or self.highlightCategory
	for i,v in pairs(self.slots) do
		v:Highlight(self.highlightCategory)
	end
end
...
function CraftSlots:Refresh()
	-- find out if a slot is highlighted	
