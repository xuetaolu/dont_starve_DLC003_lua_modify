...
local MapScreen = Class(Screen, function(self)
	...
	self.onbecomeactivefn = nil
	self.onbecomeinactivefn = nil
	self.onupdatefn = nil
...
function MapScreen:SetOnBecomeActiveFn(onbecomeactivefn)
	self.onbecomeactivefn = onbecomeactivefn
end

function MapScreen:SetOnBecomeInactiveFn(onbecomeinactivefn)
	self.onbecomeinactivefn = onbecomeinactivefn
end

function MapScreen:SetOnUpdateFn(onupdatefn)
