...
function Repairable:Repair(doer, repair_item)
    ...
    elseif self.inst.components.workable and self.inst.components.workable.workleft and self.inst.components.workable.workleft < self.inst.components.workable.maxwork then
		if repair_item.components.repairer and self.repairmaterial == repair_item.components.repairer.repairmaterial then
    ...
    elseif self.inst.components.boathealth then
		if repair_item.components.repairer and self.repairmaterial == repair_item.components.repairer.repairmaterial then
			if self.inst.components.boathealth:GetPercent() < 1 then
				if self.inst.components.boathealth.DoDelta then
