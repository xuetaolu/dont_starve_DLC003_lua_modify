...
local wave_sound = { 
	...
	["spring"] = "dontstarve/common/clouds",--"dontstarve_DLC001/spring/springwaves",
...
local AmbientSoundMixer = Class(function(self, inst)
	...
	self.ambient_sounds =
	{
		---[GROUND.IMPASSABLE] = {sound = "dontstarve/common/clouds"},
...
--{sound="dontstarve_DLC003/amb/temperate/suburbs", wintersound="dontstarve_DLC003/amb/temperate/suburbs", springsound="dontstarve_DLC003/amb/temperate/suburbs", summersound="dontstarve_DLC003/amb/temperate/suburbs", rainsound="dontstarve/rain/rainmeadowAMB"},
