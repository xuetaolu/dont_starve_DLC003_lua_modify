...
function Prototyper:SetCanPrototypeTestFunction(fn)
	self.testCanPrototypeFn = fn
end

function Prototyper:CanCurrentlyPrototype()
	if self.testCanPrototypeFn then
		return self.testCanPrototypeFn()
	end
	return true
end
