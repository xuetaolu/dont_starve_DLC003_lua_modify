...
local function insanityrock()
    ...
    inst.returntointeriorscene = function() rockstartup(inst, inst.player, forcerockactive, forcerockinactive) end
   	inst.removefrominteriorscene = turnoffpathfinding
...
local function sanityrock()
    ...
    inst.returntointeriorscene = function() rockstartup(inst, inst.player, forcerockinactive, forcerockactive) end
   	inst.removefrominteriorscene = turnoffpathfinding
