...
return Prefab( "common/inventory/machete", normal, assets),
	   Prefab( "common/inventory/goldenmachete", golden, assets),
	   Prefab( "common/inventory/obsidianmachete", obsidian, assets)
