...
local MINIMAP_GROUND_PROPERTIES =
{
	...
	{ GROUND.BEARDRUG, 	    	{ name = "map_edge",      noise_texture = "levels/textures/interior.tex"} },
	...
	{ GROUND.RAINFOREST,  	 { name = "map_edge",      noise_texture = "levels/textures/mini_noise_rainforest.tex" } },
	{ GROUND.DEEPRAINFOREST, { name = "map_edge",      noise_texture = "levels/textures/mini_noise_jungle_deep.tex" } },
  	{ GROUND.FOUNDATION,  	 { name = "map_edge",      noise_texture = "levels/textures/mini_fanstone_noise.tex" } },
  	{ GROUND.COBBLEROAD,  	 { name = "map_edge",      noise_texture = "levels/textures/mini_brickroad_noise.tex" } },
  	{ GROUND.GASJUNGLE,  	 { name = "map_edge",      noise_texture = "levels/textures/mini_gasbiome_noise.tex" } },  	
	{ GROUND.LAWN,  		 { name = "map_edge",      noise_texture = "levels/textures/mini_grasslawn_noise.tex" } },
	{ GROUND.FIELDS,  		 { name = "map_edge",      noise_texture = "levels/textures/mini_noise_farmland.tex" } },
	{ GROUND.SUBURB,  		 { name = "map_edge",      noise_texture = "levels/textures/mini_noise_mossy_blossom.tex" } },	
	{ GROUND.LILYPOND,		 { name = "map_edge",  	   noise_texture = "levels/textures/mini_lilypond_noise.tex" } },
	{ GROUND.PIGRUINS, 		 			 { name = "map_edge",  	   noise_texture = "levels/textures/map_interior/mini_ruins_slab.tex" } },
	{ GROUND.PIGRUINS_NOCANOPY, 		 { name = "map_edge",  	   noise_texture = "levels/textures/map_interior/mini_ruins_slab.tex" } },
	
	{ GROUND.PLAINS, 		 	{ name = "map_edge",  	   noise_texture = "levels/textures/mini_plains_noise.tex" } },
	{ GROUND.BATTLEGROUND, 		{ name = "map_edge",  	   noise_texture = "levels/textures/mini_battlegrounds_noise.tex" } },
	{ GROUND.PAINTED, 		 	{ name = "map_edge",  	   noise_texture = "levels/textures/mini_bog_noise.tex" } },	
	{ GROUND.DEEPRAINFOREST_NOCANOPY, { name = "map_edge",      noise_texture = "levels/textures/mini_noise_jungle_deep.tex" } },
