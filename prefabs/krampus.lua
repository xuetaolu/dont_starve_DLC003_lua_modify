...
local function OnSave(inst, data)
    if inst:HasTag("krampingplayerinterior") then
        data.krampingplayerinterior = true
    end

end

local function OnLoad(inst, data)
    if data.krampingplayerinterior then
        inst:AddTag("krampingplayerinterior")    
    end
end
...
local function fn(Sim)
    ...
    inst:AddTag("monster")
    inst:AddTag("hostile")
    inst:AddTag("scary_to_pig_guards")
    inst:AddTag("krampus")
