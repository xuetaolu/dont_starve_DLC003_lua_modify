...
require "stategraphs/SGpeacock"

local assets=
{
	Asset("ANIM", "anim/peakcock_basic.zip"),
...
return Prefab( "forest/animals/peacock", fn, assets, prefabs) 
