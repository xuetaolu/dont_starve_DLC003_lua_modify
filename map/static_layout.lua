...
local function ConvertStaticLayoutToLayout(layoutsrc, additionalProps)
	...
	layout.ground_types = {
							...
							GROUND.WOODFLOOR, 		GROUND.CARPET, 				GROUND.CHECKER,				GROUND.CAVE,
							GROUND.FUNGUS, 			GROUND.SINKHOLE, 			GROUND.WALL_ROCKY, 			GROUND.WALL_DIRT,
							
							GROUND.WALL_MARSH, 		GROUND.WALL_CAVE, 			GROUND.WALL_FUNGUS, 		GROUND.WALL_SINKHOLE, 
							...
							GROUND.BEACH, 			GROUND.JUNGLE, 				GROUND.SWAMP, 				GROUND.OCEAN_SHALLOW, 	

							GROUND.OCEAN_MEDIUM, 	GROUND.OCEAN_DEEP,			GROUND.OCEAN_CORAL, 		GROUND.MANGROVE,
							GROUND.MAGMAFIELD, 		GROUND.TIDALMARSH, 			GROUND.MEADOW,				GROUND.VOLCANO, 		

							GROUND.VOLCANO_LAVA, 	GROUND.ASH, 				GROUND.VOLCANO_ROCK, 		GROUND.OCEAN_SHIPGRAVEYARD,
							GROUND.COBBLEROAD,		GROUND.FOUNDATION,			GROUND.DEEPRAINFOREST,		GROUND.LAWN,

							GROUND.PIGRUINS, 		GROUND.LILYPOND, 			GROUND.GASJUNGLE,			GROUND.SUBURB,
							GROUND.RAINFOREST,		GROUND.PIGRUINS_NOCANOPY,	GROUND.PLAINS,				GROUND.PAINTED,

							GROUND.BATTLEGROUND, 	GROUND.INTERIOR, 			GROUND.FIELDS					}
	layout.ground = {}
