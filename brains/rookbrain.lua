...
function RookBrain:OnStart()
    local root = PriorityNode(
    {
        ...
        WhileNode( function() return (not self.inst:HasTag("hippopotamoose") or self.inst:HasTag("enraged")  ) and (self.inst.components.combat.target == nil or not self.inst.components.combat:InCooldown()) end,
            "RamAttack",
