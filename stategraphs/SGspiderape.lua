...
local states =
{
    ...
    State{
        ...
        timeline = 
        {
            TimeEvent(8*FRAMES, function(inst) 
                ...
                for i = 0, 3 do
                    inst:DoTaskInTime((i * waittime), function() inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/enemy/spiderape/bite") end)
                end
            end)
        },
    ...
    State{
        ...
        timeline = 
        {
            TimeEvent(8*FRAMES, function(inst) 
                --12 fist hits
                inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/enemy/spiderape/taunt")
...
CommonStates.AddWalkStates(states,
{
	...
	walktimeline = 
    {
        TimeEvent(1*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/enemy/spiderape/idle") end),
        TimeEvent(4*FRAMES, function(inst) PlayFootstep(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC001/common/boss_step") end),
        TimeEvent(5*FRAMES, function(inst) PlayFootstep(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC001/common/boss_step") end),
...
CommonStates.AddCombatStates(states,
{
    attacktimeline = 
    {        
        TimeEvent(5*FRAMES, function(inst)inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/enemy/spiderape/bite") end),
    ...
    {
    TimeEvent(1*FRAMES, function(inst)
            inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/enemy/spiderape/hurt") end),
    },

    deathtimeline =
    {
        TimeEvent(1*FRAMES, function(inst)
            inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/enemy/spiderape/death") end),
    },
})
