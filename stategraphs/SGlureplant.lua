	...
	State
	{
        ...
        onenter = function(inst, playanim)
        	...
        	if inst.lure then
                ...
                local symbol = inst.lure.prefab
                if inst.lure and inst.lure.components.dryable then
                    symbol = inst.lure.components.dryable:GetOverrideSymbol()
                end

	        	inst.AnimState:OverrideSymbol("swap_dried", "meat_rack_food", symbol)
	            inst.Physics:Stop()          
