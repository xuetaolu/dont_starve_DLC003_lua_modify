...
-- RUN STATES FOR LOOPING SOUND
     ...
     State{
        ...
        onenter = function(inst) 
            ...
            -- inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/enemy/rabid_beetle/talk_LP", "talksound")
                ...
                timeline=
        {
            TimeEvent(0*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/enemy/rabid_beetle/run") end),
    ...
    State{
        ...
        timeline=
        {
            TimeEvent(0*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/glowfly/hatch") end),
